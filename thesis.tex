...
\input{1_frontmatter/copyrightpage}
\input{1_frontmatter/titlepage}
\input{1_frontmatter/approvalpage}  %HMS replace uline with underline - problem for long titles. 
\input{1_frontmatter/acknowledgements}
...
\input{2_mainmatter/introduction}
\input{2_mainmatter/background}
\input{2_mainmatter/implementation}
\input{2_mainmatter/measurement}
\input{2_mainmatter/results}
\input{2_mainmatter/conclusion}

\part{Accessibility Tests}
\input{2_mainmatter/testrequirements}
\input{2_mainmatter/testlisting}
\input{2_mainmatter/testmath}
\input{2_mainmatter/testtable}
\iftikz
...
\input{3_backmatter/testappendixtable}
