...
\item test figure captions and references to figures as in Figure \ref{fig:smileyface}. The test is in Chapter \ref{ch:background}.
...
\begin{enumerate}
    \item Canvas
    \item Adobe Acrobat Professional - checker, preflight
    \item veraPDF\cite{iso:veraPDF} tests for conformity to ISO Standard 32005\cite{iso:32005, pdf:hierarchyrules}
\end{enumerate}